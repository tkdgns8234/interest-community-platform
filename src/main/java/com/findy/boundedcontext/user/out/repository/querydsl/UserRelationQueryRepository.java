package com.findy.boundedcontext.user.out.repository.querydsl;

import com.findy.boundedcontext.user.out.repository.entity.QUserEntity;
import com.findy.boundedcontext.user.out.repository.entity.QUserRelationEntity;
